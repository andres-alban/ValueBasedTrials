% This script takes ~12'
load('explore_caseI.mat')
...
% Save data
save('SimCompStats_caseI.mat','results_pos','comp_stats_PH','comp_stats_n0','comp_stats_sigmaX','comp_stats_c')

% print results
% Note: The scenarios in which r*=rmax output NaNs
fileID = fopen('comp_stats_caseI.txt','w');
